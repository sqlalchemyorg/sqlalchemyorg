...
<h2>Source Access</h2>
<p>
    SQLAlchemy's source code is versioned using <a href="http://git-scm.com/">Git</a>.
    The primary public repository is at <b>GitHub</b>:
</p>

<ul>
    <li>
        <strong>GitHub:</strong> <a href="https://github.com/sqlalchemy/sqlalchemy/">https://github.com/sqlalchemy/sqlalchemy/</a>
        <p>
            <br/>
            <code>
...
<p>
    Please note the <b>Guidelines for Pull Requests</b> which modify
    source code (e.g. not just documentation):
</p>

<ul>
    <li><a name="pr-requires-issue"></a>
        <b>Issues for Pull Requests:
        <em>It is required to submit an issue in the issue tracker before submitting a pull request.</em>
        </b>
        ...
        before the contributor makes the effort to write the code and tests.
        The issue number used by Github is also linked in the changelog and is used to 
        generate a changelog file entry for merge.
    </li>
    <li>
        <a name="pr-requires-tests"></a>
        <b>Always include tests with the change in code</b> - SQLAlchemy does not
        ...
        bug report</a> for code changes where you aren't able to provide tests</b>.
    </li>
    <li><b>Please follow up for "requests for changes" on your pull request, as well
        as subscribe to the Gerrit review to receive comments.</b> - Pull requests where
        requested changes are not responded towards will be closed.
    </li>
    <li>Please make sure you are configured to run the current <a href="#environment">Development Environment</a>
        requirements, which will help ensure your PRs pass automatic tests.
    </li>
    <li>Instead of editing the Changelog file itself, please adopt the following workflow:
        <ul>
            <li>If the PR does not already have a corresponding issue in GitHub,
                please create a new issue in GitHub.
                (See <a href="#pr-requires-issue">Issues for Pull Requests</a>)
            </li>
...
<p>
    The tests themselves have been written over the course of many years, and stylistically have evolved.   We try
    ...
    that many of our tests are certainly not yet in this style, is as follows:
</p>
...
<ul>
    <li>Tests should stick to <a href="http://www.python.org/dev/peps/pep-0008/">PEP8</a>.
        ...
        in which we welcome new help.
    </li>
    <li>
        Test just one thing.   A series of individual assertions are best broken up into individual
        test methods, rather than one test method with several assertions.
    </li>
    <li>Maintain per-test state as local to a test fixture.   That is, if a series of tests are all
        ...
        help greatly with this process, under <code>test/lib/fixtures.py</code>.
    </li>
...
<ul>
    <li>Try to stick to <a href="http://www.python.org/dev/peps/pep-0008/">PEP8</a> as much as possible.
        ...
        in particular SQLAlchemy generative queries are most easy to read broken up along backslashes.
    </li>
    <li>New features can only be added if they have associated documentation that
        runs under <a href="#documentation">Sphinx.</a>
    </li>
    <li>No feature or bug fix is ever committed without full <a href="#testing">unit tests</a>
        to as much a degree as possible.
    </li>
    <li>Please make sure you are configured to run the current <a href="#environment">Development Environment</a>
        requirements, which will help ensure your PRs pass automatic tests.
    </li>
...
<p>
    The SQLAlchemy project has recently standardized to adopting a few conventions during development,
    most of which can be automatically enforced by a properly configured development environment.
</p>
<ul>
    <li>Source code formatting and other utilities are automatically applied using hooks in the <a href="https://pre-commit.com ">pre-commit</a> framework.
        `pre-commit` can be installed by running <code>pip install pre-commit</code>.
    </li>
    <li>Source code is formatted using Python Software Foundation's <a href="https://black.readthedocs.io/en/stable/">black</a>.
        ...
        however `pre-commit` should automatically install it in most situations.
    </li>
</ul>
<p>
    TLDR; please ensure <a href="https://pre-commit.com ">pre-commit</a> is installed in your environment before beginning work on a Pull Request.
</p>
...
<h2>Sprints</h2>
<p>
    The SQLAlchemy project has an interest in attracting developers through sprints.   Currently,
