...
<%self:user
        name="Adroll",
        logo="adroll_itsfine_mr_adblocker.png"
...
<%self:user
        name="The Diamond App"
        logo="thediamondapp.png"
        url="http://www.thediamondapp.com"
        anchor="thediamondapp.com">
        <a href="http://www.thediamondapp.com">The Diamond App</a>
        is the world's first diamond price tracker. The Diamond App uses Django,
        MySQL, and SQLAlchemy to analyze the prices of hundreds of thousands of diamonds every single day.
</%self:user>
